...
resource "aws_instance" "mozart" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo region = ${var.region} >> ~/.aws/credentials",
      ...
      "mkdir -p ~/mozart/ops",
      "echo >> ~/.bash_profile",
      "echo '# source virtualenv' >> ~/.bash_profile",
      "echo 'export MOZART_DIR=$$HOME/mozart' >> ~/.bash_profile",
      "echo 'source $$MOZART_DIR/bin/activate' >> ~/.bash_profile"
    ]
  }

  provisioner "remote-exec" {
    inline = [
      "echo export MOZART_PVT_IP=${aws_instance.mozart.private_ip} > cluster_env.sh",
      "echo export MOZART_PUB_IP=${aws_instance.mozart.public_ip} >> cluster_env.sh",
      "echo export MOZART_RABBIT_PVT_IP=${aws_instance.mozart.private_ip} >> cluster_env.sh",
      "echo export MOZART_RABBIT_PUB_IP=${aws_instance.mozart.public_ip} >> cluster_env.sh",
      "echo export MOZART_REDIS_PVT_IP=${aws_instance.mozart.private_ip} >> cluster_env.sh",
      "echo export MOZART_REDIS_PUB_IP=${aws_instance.mozart.public_ip} >> cluster_env.sh",
      "echo export MOZART_ES_PVT_IP=${aws_instance.mozart.private_ip} >> cluster_env.sh",
      "echo export MOZART_ES_PUB_IP=${aws_instance.mozart.public_ip} >> cluster_env.sh",
      "echo export METRICS_PVT_IP=${aws_instance.metrics.private_ip} >> cluster_env.sh",
      "echo export METRICS_PUB_IP=${aws_instance.metrics.public_ip} >> cluster_env.sh",
      "echo export METRICS_REDIS_PVT_IP=${aws_instance.metrics.private_ip} >> cluster_env.sh",
      "echo export METRICS_REDIS_PUB_IP=${aws_instance.metrics.public_ip} >> cluster_env.sh",
      "echo export METRICS_ES_PVT_IP=${aws_instance.metrics.private_ip} >> cluster_env.sh",
      "echo export METRICS_ES_PUB_IP=${aws_instance.metrics.public_ip} >> cluster_env.sh",
      "echo export GRQ_PVT_IP=${aws_instance.grq.private_ip} >> cluster_env.sh",
      "echo export GRQ_PUB_IP=${aws_instance.grq.public_ip} >> cluster_env.sh",
      "echo export GRQ_ES_PVT_IP=${aws_instance.grq.private_ip} >> cluster_env.sh",
      "echo export GRQ_ES_PUB_IP=${aws_instance.grq.public_ip} >> cluster_env.sh",
      "echo export FACTOTUM_PVT_IP=${aws_instance.factotum.private_ip} >> cluster_env.sh",
      "echo export FACTOTUM_PUB_IP=${aws_instance.factotum.public_ip} >> cluster_env.sh",
      "echo export CI_PVT_IP=${aws_instance.ci.private_ip} >> cluster_env.sh",
      "echo export CI_PUB_IP=${aws_instance.ci.public_ip} >> cluster_env.sh",
      "echo export VERDI_PVT_IP=${aws_instance.ci.private_ip} >> cluster_env.sh",
      "echo export VERDI_PUB_IP=${aws_instance.ci.public_ip} >> cluster_env.sh"
    ]
  }
}
...
resource "aws_instance" "metrics" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo >> ~/.bash_profile",
      "echo '# source virtualenv' >> ~/.bash_profile",
      "echo 'export METRICS_DIR=$$HOME/metrics' >> ~/.bash_profile",
      "echo 'source $$METRICS_DIR/bin/activate' >> ~/.bash_profile"
    ]
  }
}
...
resource "aws_instance" "grq" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo >> ~/.bash_profile",
      "echo '# source virtualenv' >> ~/.bash_profile",
      "echo 'export SCIFLO_DIR=$$HOME/sciflo' >> ~/.bash_profile",
      "echo 'source $$SCIFLO_DIR/bin/activate' >> ~/.bash_profile"
    ]
  }
}
...
resource "aws_instance" "factotum" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo >> ~/.bash_profile",
      "echo '# source virtualenv' >> ~/.bash_profile",
      "echo 'export VERDI_DIR=$$HOME/verdi' >> ~/.bash_profile",
      "echo 'source $$VERDI_DIR/bin/activate' >> ~/.bash_profile"
    ]
  }
}
